...
//        }
            ...
            while (ordering) {
                System.out.println("What would you like to order? Please use the number associated " +
                        "\nwith each item to order");
                ...
                String countinueOrder = input.nextLine();

                if (!countinueOrder.equalsIgnoreCase("Y")) {
                    ordering = false;
                }
            ...
            for (int i = 2; i < order.size(); i++) {
                ...
                } else if (order.get(i).equals(drinkMenu.get(1).getPrice())) {
                    drinkMenu.get(1).type();
                    System.out.println(drinkMenu.get(1).getPrice());
                    subtotal = subtotal + drinkMenu.get(1).getPrice();
                } else if (order.get(i).equals(drinkMenu.get(2).getPrice())) {
